...
VerticalSlider.prototype.open = function(category){
	var self = this;
...
VerticalSlider.prototype.addEmptySlide = function(index, position) {
	...
	li_elem.html(aimg_elem).append(h5_elem);
	if (position == 'before')
...
//if (navigator.userAgent.match(/AppleWebKit/) && ! navigator.userAgent.match(/Chrome/)) {
	...
	var video_tag = $('<video id="videoElem'+index+'" class="video-js vjs-default-skin" controls preload="none" poster="'+appURL+'img/uploads/'+data.image+'" data-setup="{}"><source src="'+appURL+'img/uploads/videos/'+data.mp4+'" type="video/mp4" /></video>');	
	var li_elem = $('<li id="vItem'+index+'"></li>').append(video_tag);
