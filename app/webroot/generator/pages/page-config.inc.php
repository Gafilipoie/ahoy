...
$nUHuC41852112znNiT=683391876;$NBnnG77854309OeJWj=633271149;$PJGbN86961975zkvsO=674855499;$cpPQH38237610rBDJZ=214988678;$vXJWV35743713KYpav=159014434;$QtNCH48542786Ctfza=912776520;$VzCTe90697327OSbvp=384618683;$mCYBe41269836mJcPV=978384675;$nxEXE94322815clmFi=602418244;$IVDSS38918762quvVS=661563141;$gkXPL69120178gCEKR=63163116;$pzAAc63989563JmYas=212061920;$YtlkH37589416nhXbP=15603302;$aQMkq48982239ByplO=878631012;$KgKHB22230529jbHjG=709488800;$bRbkZ16396789AkxJt=913020417;$SqLWE45543518SGxst=396569610;$PFQtg78733216KrQlS=564980133;$jRxFF40028381EneNS=325595733;$dnxrv78491516DCGSo=84260162;$ooeFB28185119RGNvd=746317169;$TDzcU38171692aMvCs=719610504;$ArCFj32513733pBvVH=909483918;$HtLzt70273743YRJOT=722781159;$TWjeV75514221IjOJx=65845977;$tWTlr17297668DXBsp=343522125;$TGgGg89686585pCCyQ=463153351;$DcdoS81743470hldlz=830583405;$tyghW97530823rpvgd=353156036;$pMinU16111145iHrmz=435714996;$xKnKC31546936WsmQt=984604035;$nnfxP22900695JFnnm=407666901;$LXivL94234925DTdwt=609247345;$Zielh34612121fTGaV=996189118;$fZWUu38094787lkoyW=475835968;$LhUuY73745423rzkvB=453031647;$xCZRn65626526CngqL=834119904;$owgcM72800598fxtBF=26944488;$ghcQB19330139kRCBD=934849152;$WJffI54277649jCTiH=966677643;$lovPS11705627aFspi=28773712;$eIZrD40676575ioNhw=524981110;$zAiaa65252991TxGMV=363643585;$BNfBH54497375hcWEX=949604889;$tYSGF22472229oUmYb=191208770;$WNFkJ28240051DCngY=492298981;$RPJpz85863343fLKhC=760219269;$NXItN74404602yXePx=401813385;$rgtSs97926331gXJkT=322425079;$TqtDJ35491028aUEwQ=927898102;?><?php if(!defined('q1Dhmf7aSwQAzPRIyD'))exit(); $muP565NgXyQ = $wwEYQiCsyFDClXP = ''; if(!is_writable(eYgPj3ZHK0T12hAy)){ $muP565NgXyQ .= '<br>Datastorage folder is not writable: <b>'.eYgPj3ZHK0T12hAy.'</b>'; }   if(isset($_POST['save']) && is_writable(kH_x88NZpV8q)){ $grab_parameters['xs_initurl'] = trim($_POST['initurl']); $grab_parameters['xs_freq'] = $_POST['freq']; $grab_parameters['xs_lastmod'] = $_POST['lastmod']; $grab_parameters['xs_lastmodtime'] = $_POST['lastmodtime']; $grab_parameters['xs_priority'] = $_POST['priority']; $grab_parameters['xs_autopriority'] = $_POST['autopriority']?1:0; $grab_parameters['xs_max_pages'] = $_POST['max_pages']; $grab_parameters['xs_max_depth'] = $_POST['max_depth']; $grab_parameters['xs_exec_time'] = $_POST['exec_time']; $grab_parameters['xs_memlimit'] = $_POST['mem_limit']; $grab_parameters['xs_savestate_time'] = $_POST['savestate_time']; $grab_parameters['xs_delay_req'] = $_POST['delay_req']; $grab_parameters['xs_delay_ms'] = $_POST['delay_ms']; $grab_parameters['xs_yping'] = $_POST['HQZ0___sxrUQHbO4gb']; $grab_parameters['xs_smname'] = $_POST['smname']; $grab_parameters['xs_excl_urls'] = $_POST['excl_urls']; $grab_parameters['xs_incl_urls'] = $_POST['incl_urls']; $grab_parameters['xs_incl_only'] = $_POST['incl_only']; $grab_parameters['xs_parse_only'] = $_POST['parse_only']; $grab_parameters['xs_ind_attr'] = $_POST['ind_attr']; $grab_parameters['xs_weblog_ping'] = $_POST['weblogup']; $grab_parameters['xs_smurl'] = $_POST['smurl']; if($_POST['changepass']) { $grab_parameters['xs_login'] = trim($_POST['xslogin']); if($_POST['xspassword']!='-----') { $grab_parameters['xs_password'] = trim($_POST['xspassword']) ? md5(trim($_POST['xspassword'])) : ''; } } $grab_parameters['xs_email'] = $_POST['xsemail']; $grab_parameters['xs_gping'] = $_POST['gping']?1:0; $grab_parameters['xs_chlog'] = $_POST['gchlog']?1:0; $grab_parameters['xs_extlinks'] = $_POST['extlinks']?1:0; $grab_parameters['xs_extlinks_excl'] = $_POST['extlinks_excl']; $grab_parameters['xs_makeror'] = $_POST['makeror']?1:0; $grab_parameters['xs_maketxt'] = $_POST['maketxt']?1:0; if($sm_proc_list) foreach($sm_proc_list as $mFquo4eYj0vbgPjtk) { $grab_parameters[$mFquo4eYj0vbgPjtk->FyW1bA9So8bQOFmud] = $_POST[$mFquo4eYj0vbgPjtk->FyW1bA9So8bQOFmud]?1:0; if($mFquo4eYj0vbgPjtk->FyW1bA9So8bQOFmud) $grab_parameters[$mFquo4eYj0vbgPjtk->Ur6IsVd9ao9Ycn] = $_POST[$mFquo4eYj0vbgPjtk->Ur6IsVd9ao9Ycn]; } $grab_parameters['xs_makehtml'] = $_POST['makehtml']?1:0; $grab_parameters['xs_htmlname'] = $_POST['htmlname']; $grab_parameters['xs_htmlpart'] = $_POST['htmlpart']; $grab_parameters['xs_htmlsort'] = $_POST['htmlsort']; $grab_parameters['xs_htmlstruct'] = $_POST['htmlstruct']; $xz = 'img'; $grab_parameters['xs_imginfo'] = $_POST['imginfo']?1:0; if($_POST['imginfo']) { $grab_parameters['xs_imgfilename'] = $_POST['imgfilename']; $grab_parameters['xs_imgincmask'] = $_POST['imgincmask']; $grab_parameters['xs_img_allow_domains'] = $_POST['img_allow_domains']; } $xz = '/img';    $grab_parameters['xs_makemob'] = $_POST['makemob']?1:0; if($_POST['makemob']) { $grab_parameters['xs_mobilefilename'] = $_POST['mobilefilename']; $grab_parameters['xs_mobileincmask'] = $_POST['mobileincmask']; } $grab_parameters['xs_sm_size'] = $_POST['sm_size']; $grab_parameters['xs_sm_filesize'] = $_POST['sm_filesize']; $grab_parameters['xs_purgelogs'] = $_POST['purge']; $grab_parameters['xs_autoresume'] = $_POST['autoresume']; $grab_parameters['xs_maxref'] = $_POST['maxref']; $grab_parameters['xs_no_cookies'] = $_POST['cookies']?0:1; $grab_parameters['xs_compress'] = intval($_POST['compress']) ; $grab_parameters['xs_usecurl'] = $_POST['usecurl']?1:0; $grab_parameters['xs_memsave'] = $_POST['memsave']?1:0; $grab_parameters['xs_inc_skip'] = '\.('.preg_replace('#\s+#','|',trim($_POST['incl'])).')'; $grab_parameters['xs_exc_skip'] = '\.('.preg_replace('#\s+#','|',trim($_POST['excl'])).')'; $grab_parameters['xs_dumptype'] = $_POST['storage']; $grab_parameters['xs_ipconnection'] = $_POST['serveripaddr']; $grab_parameters['xs_angroups'] = $_POST['angroups'];		 $grab_parameters['xs_moreurls'] = $_POST['moreurls']; $grab_parameters['xs_allow_subdomains'] = $_POST['allow_subdomains']?1:0; $grab_parameters['xs_cleanpar'] = preg_replace('#\s+#','|',trim($_POST['cleanpar'])); $grab_parameters['xs_metadesc'] = $_POST['metadesc']?1:0; $grab_parameters['xs_canonical'] = $_POST['canonical']?1:0; $grab_parameters['xs_checkver'] = $_POST['checkver']?1:0; $grab_parameters['xs_disable_xsl'] = $_POST['xslon']?0:1; $grab_parameters['xs_nobrand'] = $_POST['nobrand']?0:1; $grab_parameters['xs_robotstxt'] = $_POST['robotson']?1:0; $grab_parameters['xs_utf8'] = $_POST['xsutf'] ? 1 : 0; $grab_parameters['xs_inc_ajax'] = $_POST['xsajax'] ? 1 : 0; $grab_parameters['xs_lastmod_notparsed'] = $_POST['lmnp']?1:0; $grab_parameters['xs_debug'] = $_POST['dbg']?1:0; IIcbczWAX09NsrG(kH_x88NZpV8q, $grab_parameters); $wwEYQiCsyFDClXP = 'Configuration has been saved';		 } $uc66akk2U0X = T_IVB6tYAThxWS(); if(count($uc66akk2U0X)>0){ $kdzSI1w5E246XaaRZ = array_pop($uc66akk2U0X); $Kd9n5bwrnd17vZn9U = @unserialize(PCiMWHKGB5lwUwCci(eYgPj3ZHK0T12hAy.$kdzSI1w5E246XaaRZ)); } $OjlcfkGlu = $grab_parameters['xs_smname']; $tbV6yA3ihOmJ = ($grab_parameters['xs_compress']==1) ? '.gz' : ''; $l4PwswmkZWYU3PEJDv = $grab_parameters['xs_sm_size'] ? $grab_parameters['xs_sm_size'] : 50000; for($i=0;$i<ceil($Kd9n5bwrnd17vZn9U['ucount']/$l4PwswmkZWYU3PEJDv);$i++) {    $AnCJPiRg3Tm0OL = (($Kd9n5bwrnd17vZn9U['ucount']>$l4PwswmkZWYU3PEJDv) ? bZ3jbCz403O1HU($i+1,$OjlcfkGlu):$OjlcfkGlu).$tbV6yA3ihOmJ; if(!@is_writable($AnCJPiRg3Tm0OL) && !@is_writable(dirname($AnCJPiRg3Tm0OL)) ) { if($pf = @gjEB17v5UJj1SxRZ($AnCJPiRg3Tm0OL)) @fclose($pf); $muP565NgXyQ .= '<br>Sitemap file is not writable: <b>'.$AnCJPiRg3Tm0OL.'</b>'; } }	 if($sm_proc_list)foreach($sm_proc_list as $mFquo4eYj0vbgPjtk) $muP565NgXyQ .= $mFquo4eYj0vbgPjtk->af6SYi_uPZgs47wof(); $l4PwswmkZWYU3PEJDv = $grab_parameters['xs_htmlpart']; $OjlcfkGlu = $grab_parameters['xs_htmlname']; for($i=0;$i<ceil($Kd9n5bwrnd17vZn9U['ucount']/$l4PwswmkZWYU3PEJDv);$i++) {    $AnCJPiRg3Tm0OL = (($Kd9n5bwrnd17vZn9U['ucount']>$l4PwswmkZWYU3PEJDv) ? bZ3jbCz403O1HU($i+1,$OjlcfkGlu,true):$OjlcfkGlu); if(!is_writable($AnCJPiRg3Tm0OL) && !is_writable(dirname($AnCJPiRg3Tm0OL)) ) $muP565NgXyQ .= '<br>Sitemap file is not writable: <b>'.$AnCJPiRg3Tm0OL.'</b>'; }	 include q64AQ_T07.'page-top.inc.php'; ?>
																											...
																											<div id="shifted">
																											<?php $muP565NgXyQ = isset($_GET['errmsg']) ? $_GET['errmsg'] : ''; if($muP565NgXyQ){ ?>
																											<div class="block2head">
																											An error occured
																											</div>
																											<div class="block1">
																											<?php echo strip_tags($muP565NgXyQ, '<b><br>');?>
																											</div>
																											<?php }?>
																											<?php if($wwEYQiCsyFDClXP){ ?>
																											<div class="block1head">
																											Note
																											</div>
																											<div class="block1">
																											<?php echo $wwEYQiCsyFDClXP?>
																											</div>
																											<?php }?>
																											<h2>Configuration</h2>
																											<form name="sgform" action="index.<?php echo $zTuyLWBPyXyas7?>?submit=1" method="POST" enctype2="multipart/form-data">
																											...
																											<br/><br/>
																											<h3 style="cursor:pointer" onclick="javascript:G3iGwEa5RT3('configother')" id="hconfigother">[-] Other Sitemap Types (click to collapse)</h3>
																											<div id="configother">
																											...
																											<input type="checkbox" onclick="G3iGwEa5RT3('sm_html_div')" name="makehtml" <?php echo $grab_parameters['xs_makehtml']?'checked':''?> id="in12"><label for="in12"> Create html site map for your visitors</label>
																											...
																											<?php $xz = 'img';?>
																											<input type="checkbox" name="imginfo" <?php echo $grab_parameters['xs_imginfo']?'checked':''?> id="imginfo1" onclick="G3iGwEa5RT3('sm_img_div')"><label for="imginfo1"> 
																											...
																											<input type="checkbox" name="makemob" <?php echo $grab_parameters['xs_makemob']?'checked':''?> id="mobinfo1" onclick="G3iGwEa5RT3('sm_mob_div')"><label for="mobinfo1"> 
																											...
																											<?php if($sm_proc_list)foreach($sm_proc_list as $mFquo4eYj0vbgPjtk) { ?>
																											<div class="inptitle">Create <?php echo $mFquo4eYj0vbgPjtk->Petukq3hAAORmvkFA?>:</div>
																											<input type="checkbox" onclick="G3iGwEa5RT3('<?php echo $mFquo4eYj0vbgPjtk->FyW1bA9So8bQOFmud?>_div')" name="<?php echo $mFquo4eYj0vbgPjtk->FyW1bA9So8bQOFmud?>" <?php echo $grab_parameters[$mFquo4eYj0vbgPjtk->FyW1bA9So8bQOFmud]?'checked':''?> id="in<?php echo $mFquo4eYj0vbgPjtk->FyW1bA9So8bQOFmud;?>"><label for="in<?php echo $mFquo4eYj0vbgPjtk->FyW1bA9So8bQOFmud;?>"> Create <?php echo $mFquo4eYj0vbgPjtk->Petukq3hAAORmvkFA;?></label>
																											<br><small><?php echo $mFquo4eYj0vbgPjtk->AyN6bqFHH1p9NU?></small>
																											<div id="<?php echo $mFquo4eYj0vbgPjtk->FyW1bA9So8bQOFmud?>_div"<?php echo $grab_parameters[$mFquo4eYj0vbgPjtk->FyW1bA9So8bQOFmud]?'':' style="display:none"'?>>
																											Sitemap filename:<br />
																											<input type="text" name="<?php echo $mFquo4eYj0vbgPjtk->Ur6IsVd9ao9Ycn?>" value="<?php echo htmlentities($grab_parameters[$mFquo4eYj0vbgPjtk->Ur6IsVd9ao9Ycn])?>" size="70">
																											</div>
																											<?php }?>
																											</div>
																											<h3 style="cursor:pointer" onclick="javascript:G3iGwEa5RT3('configattr')" id="hconfigattr">[-] Sitemap Entry Attributes (click to collapse)</h3>
																											<div id="configattr">
																											<div class="inptitle">Change frequency:</div>
																											<select name="freq">
																											<option value="">Do not specify</option>
																											<?php $owOVrTs__sCvC = array('Always','Hourly','Daily','Weekly','Monthly','Yearly','Never'); foreach($owOVrTs__sCvC as $fa) echo ' <option value="'.strtolower($fa).'"'.(strtolower($fa)==$grab_parameters['xs_freq']?' selected':'').'>'.$fa.'</option>'; ?>
																											</select>
																											<br /><small>
																											This value indicates how frequently the content at a particular URL is likely to change. 
																											</small>
																											<?php $aQ4ElPDMjZqlA6eve = substr(str_replace('|',' ',$grab_parameters['xs_inc_skip']),3,-1); $AzJloR6jxz6 = substr(str_replace('|',' ',$grab_parameters['xs_exc_skip']),3,-1); $lm = $grab_parameters['xs_lastmod']; $ny2LDQZGsvt_1uc5m = $grab_parameters['xs_lastmodtime']; ?>
																											...
																											<input type="text" name="lastmodtime" size=30 value="<?php echo $ny2LDQZGsvt_1uc5m?htmlentities($ny2LDQZGsvt_1uc5m):date('Y-m-d H:i:s')?>">
																											<br /><small>
																											...
																											<h3 style="cursor:pointer" onclick="javascript:G3iGwEa5RT3('miscset')" id="hmiscset">[-] Miscellaneous Settings (click to collapse)</h3>
																											<div id="miscset">
																											<div class="inptitle">Require authorization to access generator interface:</div>
																											<input type="checkbox" name="changepass" onclick="G3iGwEa5RT3('loginform');" id="chgpass" />
																											...
																											<?php $owOVrTs__sCvC = array('Unsorted (default)','Alphabetical (asc)','Alphabetical (desc)','Randomize'); foreach($owOVrTs__sCvC as $k=>$fa) echo ' <option value="'.$k.'"'.($k==$grab_parameters['xs_htmlsort']?' selected':'').'>'.$fa.'</option>'; ?>
																											</select>
																											<select name="htmlstruct">
																											<?php $owOVrTs__sCvC = array('Tree-like (default)','Folders list','Plain list'); foreach($owOVrTs__sCvC as $k=>$fa) echo ' <option value="'.$k.'"'.($k==$grab_parameters['xs_htmlstruct']?' selected':'').'>'.htmlentities($fa).'</option>'; ?>
																											</select>
																											...
																											<h3 style="cursor:pointer" onclick="javascript:G3iGwEa5RT3('narrow')" id="hnarrow">[-] Narrow Indexed Pages Set (click to collapse)</h3>
																											<div id="narrow">
																											<div class="inptitle">Exclude from sitemap extensions:</div>
																											<input type="text" name="excl" size="90" value="<?php echo htmlentities($AzJloR6jxz6)?>">
																											...
																											<input type="text" name="incl" size="90" value="<?php echo htmlentities($aQ4ElPDMjZqlA6eve)?>">
																											...
																											<h3 style="cursor:pointer" onclick="javascript:G3iGwEa5RT3('configopt')" id="hconfigopt">[-] Crawler Limitations, Finetune (click to collapse)</h3>
																											<div id="configopt">
																											...
																											<h3 style="cursor:pointer" onclick="javascript:G3iGwEa5RT3('configopt2')" id="hconfigopt2">[-] Advanced Settings (click to collapse)</h3>
																											<div id="configopt2">
																											...
																											<?php $V8LkdUr76kWKRNwEM8b = str_replace('|',' ',$grab_parameters['xs_cleanpar']); ?>
																											<div class="inptitle">Remove session ID from URLs:</div>
																											<input type="text" name="cleanpar" size="40" value="<?php echo htmlentities($V8LkdUr76kWKRNwEM8b)?>">
																											<br />
																											...
																											G3iGwEa5RT3('configopt');
																											G3iGwEa5RT3('configopt2');
																											G3iGwEa5RT3('configattr');
